...
export const Badge3DSimple = ({ position = [0, 0, 0], onHover }: Badge3DSimpleProps) => {
  ...
  return (
    <Float speed={1.5} rotationIntensity={0.3} floatIntensity={0.4}>
      <group position={position}>
        ...
        {/* Center text as simple geometry - no font needed */}
        ...
        {techIcons.map((tech, index) => (
          ...
          >
            <Float speed={2 + index * 0.3} rotationIntensity={0.8} floatIntensity={0.6}>
              ...
              {/* Simple text representation without font */}
